...
Most of the other tools in this survey do not include built-in sandboxing, which is a recurring gap given the security implications of running AI agents with broad filesystem and shell access.
